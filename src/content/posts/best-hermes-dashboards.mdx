...
For the rest of the Hermes setup chain: [start here with the installer](/hermes-agent-setup-guide/), [lock down the built-in dashboard properly](/hermes-dashboard-guide/), and if you want free models, [the MIMO/Step guide](/hermes-agent-mimo-v2-pro/) still applies.
