...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgScraper} alt="Scraper Content Crawler plugin settings" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgWpScraper} alt="WP Scraper plugin banner" />
