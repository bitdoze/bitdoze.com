---
date: 2026-05-13
title: "TinyFish: Free Web Search and Fetch API for Your AI Coding Agents"
description: "TinyFish gives your AI agents structured web search and clean page fetching for free. Set it up with Pi, Hermes, OpenClaw, or any coding agent in under 5 minutes."
categories: ["AI"]
tags: ["ai-tools", "developer-tools", "llm"]
image: ../../assets/images/26/05/tinyfish-ai-agents-web-search.svg
authors: ["Dragos"]
...
I have been using TinyFish through the [pi-tinyfish](https://github.com/x1any/pi-tinyfish) package in [Pi coding agent](/pi-coding-agent-setup-guide/) for a few weeks now. It works well enough that I want to lay out what it does, how to set it up, and why it matters for agents like [Hermes](/hermes-agent-setup-guide/) and [OpenClaw](/clawdbot-setup-guide/) too.

<Button text="Get a free TinyFish API key" link="https://agent.tinyfish.ai/" variant="solid" color="blue" size="md" icon="arrow-right" />
...
The same patterns apply to [OpenClaw](/clawdbot-setup-guide/), [OpenCode](/opencode-setup-guide/), Claude Code, Cursor, Codex, and any other coding agent that supports MCP, skills, or shell access.
...
- [Get a free TinyFish API key](https://agent.tinyfish.ai/) — no credit card required
...
- [Pi coding agent setup guide](/pi-coding-agent-setup-guide/) if you have not installed Pi yet
- [Hermes Agent setup guide](/hermes-agent-setup-guide/) for Hermes installation and configuration
