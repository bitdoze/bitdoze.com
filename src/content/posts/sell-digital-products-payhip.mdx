...
translationKey: "sell-digital-products-payhip"
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgAccount} alt="Payhip account registration page" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgDash} alt="Payhip dashboard overview" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgAddProduct} alt="Adding a new product on Payhip" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgStore} alt="Payhip store builder interface" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgMarketing} alt="Payhip marketing tools" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgAnalytics} alt="Payhip analytics dashboard" />
