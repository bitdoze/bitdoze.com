...
meta_title: "How to Self-Host Cloudreve with Docker and Cloudflare"
...
image: "../../assets/images/26/01/cloudreve-docker-setup.webp"
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="Cloudflare Tunnel configuration" />
