...
description: "Discover the top 6 open source language models that can replace Claude Fable 5, Opus 4.8, or GPT-5.5 for coding tasks at a fraction of the cost: GLM-5.1, Kimi K2.6, Qwen 3.6 Plus, MiniMax M3, MiMo V2.5 Pro, and Mistral Medium 3.5."
...
MiniMax M3 and MiMo V2.5 Pro both offer 1M tokens of context, matching Opus 4.8. Kimi K2.6, Qwen 3.6 Plus, and Mistral Medium 3.5 offer 256K, while GLM-5.1 supports 200K. For even cheaper 1M context, see DeepSeek V4 Pro in our [best cheap models for Hermes Agent](/best-cheap-models-hermes-agent/) guide.
