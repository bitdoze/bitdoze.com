...
- **Largest open-weight release**: 2.8T total params; self-hosting needs cluster-class hardware, not a laptop ([what one small box can hold](/best-mini-pc-local-llm/))
