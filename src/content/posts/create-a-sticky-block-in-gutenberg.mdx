...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgStickey} alt="Adding a Sticky Block in Gutenberg editor" />

### 3. Configure sticky options

<Picture formats={["webp"]} fallbackFormat="webp" src={imgOptions} alt="Sticky Block options panel" />
