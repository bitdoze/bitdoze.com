...
meta_title: "How to Speed Up WordPress with Cloudflare, Varnish"
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgVarnish} alt="CloudPanel Varnish cache settings for a WordPress site" />
