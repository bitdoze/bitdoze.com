...
If you do not want to manage separate API keys and billing for each provider, [OpenCode Go](https://go.bitdoze.com/opencode-go) bundles all five models into a single subscription for $10/month. For a detailed look at limits and real-world usage, see the [OpenCode Go guide](/opencode-go-plan/).
