...
description: "Self-host Termix to manage SSH, tunnels, files, stats, and Docker from one dashboard. Deploy easily with Dokploy or Docker Compose."
image: "../../assets/images/25/12/self-host-termix.webp"
categories: ["vps"]
authors: ["Dragos"]
tags: ["self-hosted", "ssh", "docker", "dokploy"]
