...
This is the 2026 edition, updated for Astro 7.2, Convex 1.45, React 19, and Tailwind v4. If you're wondering [how Astro compares to Next.js and TanStack Start](/astro-vs-nextjs-vs-tanstack-start-which-wins/), the short answer is: Astro ships zero JavaScript by default and lets you hydrate only the components that need interactivity. New to Astro? You can [build a free blog with Astro](/build-astro-blog-free/) first to get comfortable with the basics.
