---
date: 2026-07-02
translationKey: "fish-audio-clone-voice"
lastmod: 2026-07-24T00:00:00Z
title: "Clona Tu Voz con Fish Audio en 2 Minutos (Guía 2026)"
description: "Clona tu voz con 15 segundos de audio en el plan gratis de Fish Audio. Paso a paso con tips de grabación, etiquetas de emoción y errores que arruinaron mi…"
image: "@assets/images/26/07/fish-audio-clone-voice.webp"
categories: ["ai"]
authors: ["Dragos"]
...
## Si una palabra sigue saliendo mal

A veces el clon esta bien pero una palabra sale mal — un nombre, una marca, un acronimo como SQL. Antes tocaba editar el guion con etiquetas de fonemas cada vez. Fish Audio ahora tiene diccionarios de pronunciacion: defines las reglas palabra-a-fonema una vez en la app web (en **Pronunciation Dictionary** del dashboard), publicas una version y se aplica a todas las generaciones. Las reglas en ingles usan CMU Arpabet, asi que `Kubernetes` pasa a `K UW2 B ER0 N EH1 T IY0 Z`. Chino y japones tienen sus propios formatos. Si generas por API, pasa el ID del diccionario publicado en la peticion, o manda un diccionario en linea para un arreglo puntual.

## Sin microfono? Usa Voice Design

Si grabar 15 segundos limpios es el problema, Voice Design crea una voz a partir de una descripcion en texto — edad, acento, tono, ritmo — en unos 15 segundos, sin audio. Es gratis en la web durante el lanzamiento (normalmente 2.000 creditos por generacion). El resultado es un modelo de voz que usas igual que un clon. No sera *tu* voz, que es el punto de clonar, pero para un personaje o una narracion rapida es el camino mas corto.
...
- [Reseña Fish Audio 2026](/es/resena-fish-audio/) — precios, API gratis, lo bueno y lo malo
- [Fish Audio vs ElevenLabs](/es/fish-audio-vs-elevenlabs/) — si vienes de ElevenLabs
- [Fish Audio vs MiniMax](/es/fish-audio-vs-minimax/) — otra alternativa de voz IA
</Notice>
