...
He estado probando [nanobot](https://github.com/HKUDS/nanobot) durante la última semana junto con mi [configuración de OpenClaw](/es/guia-configuracion-openclaw/). La idea es simple: un asistente personal de IA en unas 3,700 líneas de Python que se conecta a Telegram, Discord, WhatsApp, Slack y un montón de otras plataformas de chat. Lo que me llamó la atención fue lo rápido que es configurarlo comparado con OpenClaw, y lo bien que funciona con proveedores LLM más baratos como MiniMax y GLM-5 de Zhipu.
