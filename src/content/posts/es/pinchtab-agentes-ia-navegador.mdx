...
translationKey: "pinchtab-browser-ai-agents"
title: "Pinchtab: Control del Navegador vía HTTP para Agentes de IA"
description: "Pinchtab es un binario Go de 12MB que da a cualquier agente de IA control del navegador a través de una API HTTP simple usando árboles de accesibilidad."
image: "@assets/images/26/02/pinchtab-browser-ai-agents.webp"
categories: ["ai"]
authors: ["Dragos"]
