...
meta_title: "Guía de Kanban Hermes: Tableros de Tareas para Flujos"
description: "Aprende a configurar y usar Hermes Kanban — el sistema de tableros de tareas integrado que aporta gestión de proyectos estructurada a los flujos de trabajo…"
categories: ["ai"]
...
<Button text="Más guías de herramientas de IA" link="/categories/ai/" variant="solid" color="blue" size="md" icon="arrow-right" iconPosition="right" />
