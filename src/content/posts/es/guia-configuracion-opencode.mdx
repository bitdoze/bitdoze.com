...
image: "@assets/images/26/04/opencode-setup-guide.webp"
categories: ["AI"]
authors: ["Dragos"]
...
<li>Configurar OpenCode Go por $10/mes con acceso a 12 modelos</li>
...
Si no quieres gestionar multiples API keys, [OpenCode Go](https://go.bitdoze.com/opencode-go) incluye 12 modelos open source populares en una sola suscripcion por $10/mes. Para un analisis detallado con limites y uso real, consulta la [guia de OpenCode Go](/opencode-go-plan/).
