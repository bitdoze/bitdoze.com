...
Ambos también soportan [OpenCode Go](https://go.bitdoze.com/opencode-go) como proveedor integrado. A $10/mes ($5 el primer mes), incluye 14 modelos como MiniMax M2.7, Qwen 3.6 Plus, GLM 5.1, DeepSeek V4 Pro, y Kimi K2.6. Para un análisis detallado con límites y uso real, consulta la [review de OpenCode Go](/opencode-go-review/). Para un análisis de estos modelos y sus benchmarks, consulta la [guía de mejores modelos baratos](/es/mejores-modelos-baratos-hermes-agent/).
