...
image: "@assets/images/26/04/pi-coding-agent-setup.webp"
categories: ["AI"]
authors: ["Dragos"]
...
[OpenCode Go](https://go.bitdoze.com/opencode-go) es una suscripción de $10/mes que incluye 12 modelos como MiniMax M2.7, Qwen 3.6 Plus, GLM 5.1, DeepSeek V4 Pro, y Kimi K2.6. Pi lo soporta como proveedor integrado. Para un análisis detallado, consulta la [guía de OpenCode Go](/opencode-go-plan/).
