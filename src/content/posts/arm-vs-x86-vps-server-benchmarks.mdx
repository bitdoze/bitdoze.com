...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgArm} alt="ARM VPS WordPress benchmark results" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgX86Yabs} alt="x86 AMD VPS yabs.sh benchmark results" />

The CPU scores are close. IO and network are similar. You're not getting dramatically more compute for the extra money.

### WordPress benchmark

<Picture formats={["webp"]} fallbackFormat="webp" src={imgX86Wp} alt="x86 AMD VPS WordPress benchmark results" />
