...
Worth noting: [Fish Shell](/install-fish-shell-ubuntu/) ships with autosuggestions and rich completions out of the box, no plugins needed. See my [Fish Shell vs Zsh](/fish-shell-vs-zsh/) comparison if you want to explore that option.
