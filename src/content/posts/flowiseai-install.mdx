...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="FlowiseAI add flow" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag3} alt="Use the FlowiseAI Chatflow Externally" />
...
If you want to explore more Docker containers for your home server, check out our guide on [Best 100+ Docker Containers for Home Server](https://www.bitdoze.com/docker-containers-home-server/). For the wider AI tooling map — including n8n, Dify, and Langflow as actively maintained workflow options — see [top AI GitHub repos](/top-ai-github-repos/).
