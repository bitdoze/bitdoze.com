...
description: "A beginner-friendly guide to Vercel Eve. Scaffold a durable AI agent as plain files, add a tool, connect it to Slack and Discord, swap in open source models…"
image: "../../assets/images/26/06/vercel-eve-ai-agent.webp"
categories: ["ai"]
authors: ["Dragos"]
tags: ["vercel", "self-hosted"]
