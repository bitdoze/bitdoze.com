...
[OpenCode Go](https://go.bitdoze.com/opencode-go) is a $10/month subscription ($5 first month) that bundles 14 models including MiniMax M2.7, Qwen 3.6 Plus, GLM 5.1, DeepSeek V4 Pro, and Kimi K2.6. Pi supports it as a built-in provider. For a detailed review with limits and benchmarks, see the [OpenCode Go review](/opencode-go-review/).
