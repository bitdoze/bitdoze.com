...
meta_title: "How to Install LangFlow with Docker Compose and Add SSL"
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="Cloudflare Tunnel setup" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="LanfFlow UI" />
...
If you want to explore more Docker containers for your home server, check out our guide on [Best 100+ Docker Containers for Home Server](https://www.bitdoze.com/docker-containers-home-server/). Langflow also sits next to n8n, Dify, and the rest of the agent stack in [top AI GitHub repos](/top-ai-github-repos/).
