...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgSsl} alt="CloudPanel admin SSL certificate setup" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgPorts} alt="CloudPanel firewall port configuration" />

Use the **My IP** option to automatically add your current IP:

<Picture formats={["webp"]} fallbackFormat="webp" src={imgMyIp} alt="CloudPanel adding your IP to firewall whitelist" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgSnapshots} alt="CloudPanel automated snapshots configuration" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgRemote} alt="CloudPanel remote backup configuration" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgCloudflare} alt="CloudPanel Cloudflare integration setting" />
