...
<Button text="Check Latest Price on Amazon" link="/go/sound-blaster-gs5/" variant="solid" color="blue" size="md" icon="arrow-right" />
...
<Button text="Check Current Price on Amazon" link="/go/sound-blaster-gs5/" variant="solid" color="green" size="md" />
...
A [MEREDO Sound Bar](/go/meredo-soundbar/) is a 3.1 channel system with subwoofer — fundamentally different from the GS5. Much larger, much more bass, much more money. Only consider this if you want a full sound system rather than a compact desktop soundbar.
</Tab>
</Tabs>
...
<Button text="Buy the Sound Blaster GS5 on Amazon" link="/go/sound-blaster-gs5/" variant="solid" color="blue" size="lg" icon="arrow-right" />
