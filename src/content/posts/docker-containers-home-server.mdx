...
Don't install 125 containers on day one. Pick one goal from the table at the top, finish that stack, then expand. More apps: [toolhunt.net self-hosted](https://toolhunt.net/sh/).
