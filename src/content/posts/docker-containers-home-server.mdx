...
| Container | Category | Description | Section Link |
|-----------|----------|-------------|--------------|
| [Plex](#plex) | Media Management | Media server for streaming movies, TV shows, and music | [Media Management](#media-management-containers) |
| [Jellyfin](#jellyfin) | Media Management | Open-source alternative to Plex for media streaming | [Media Management](#media-management-containers) |
| [Emby](#emby) | Media Management | Media server with premium features for enhanced streaming | [Media Management](#media-management-containers) |
| [Sonarr](#sonarr) | Media Management | TV series collection manager with automatic downloads | [Media Management](#media-management-containers) |
| [Radarr](#radarr) | Media Management | Movie collection manager with automatic downloads | [Media Management](#media-management-containers) |
| [Lidarr](#lidarr) | Media Management | Music collection manager for artists and albums | [Media Management](#media-management-containers) |
| [Jackett](#jackett) | Media Management | Proxy server for torrent trackers and indexers | [Media Management](#media-management-containers) |
| [Transmission](#transmission) | Media Management | BitTorrent client with web interface | [Media Management](#media-management-containers) |
| [qBittorrent](#qbittorrent) | Media Management | Feature-rich BitTorrent client with web UI | [Media Management](#media-management-containers) |
| [Nextcloud](#nextcloud) | File Sharing & Sync | Self-hosted cloud storage and collaboration platform | [File Sharing and Sync](#file-sharing-and-sync-containers) |
| [Syncthing](#syncthing) | File Sharing & Sync | Continuous file synchronization across devices | [File Sharing and Sync](#file-sharing-and-sync-containers) |
| [Seafile](#seafile) | File Sharing & Sync | Professional file sync and share solution | [File Sharing and Sync](#file-sharing-and-sync-containers) |
| [ownCloud](#owncloud) | File Sharing & Sync | Enterprise file sharing and collaboration | [File Sharing and Sync](#file-sharing-and-sync-containers) |
| [Filebrowser](#filebrowser) | File Sharing & Sync | Web-based file manager with sharing capabilities | [File Sharing and Sync](#file-sharing-and-sync-containers) |
| [SFTPGo](#sftpgo) | File Sharing & Sync | Secure file transfer protocol server | [File Sharing and Sync](#file-sharing-and-sync-containers) |
| [Ollama with OpenWebUI](#ollama-with-openwebui) | AI Applications | Local LLM hosting with web interface | [AI Applications](#ai-applications-containers) |
| [Flowise](#flowise) | AI Applications | Visual AI workflow builder and chatbot creator | [AI Applications](#ai-applications-containers) |
| [Langflow](#langflow) | AI Applications | Visual framework for building LangChain applications | [AI Applications](#ai-applications-containers) |
| [Langfuse](#langfuse) | AI Applications | LLM engineering platform for observability and analytics | [AI Applications](#ai-applications-containers) |
| [LiteLLM](#litellm) | AI Applications | Unified API for 100+ LLM providers | [AI Applications](#ai-applications-containers) |
| [Home Assistant](#home-assistant) | Home Automation | Comprehensive home automation platform | [Home Automation](#home-automation-containers) |
| [Node-RED](#node-red) | Home Automation | Visual programming tool for IoT and automation | [Home Automation](#home-automation-containers) |
| [Mosquitto MQTT Broker](#mosquitto-mqtt-broker) | Home Automation | Lightweight MQTT message broker | [Home Automation](#home-automation-containers) |
| [OpenHAB](#openhab) | Home Automation | Vendor-neutral home automation platform | [Home Automation](#home-automation-containers) |
| [Pi-hole](#pi-hole) | Network Management | Network-wide ad blocker and DNS sinkhole | [Network Management](#network-management-containers) |
| [Unbound](#unbound) | Network Management | Recursive DNS resolver for enhanced privacy | [Network Management](#network-management-containers) |
| [Traefik](#traefik) | Network Management | Reverse proxy and load balancer with auto-discovery | [Network Management](#network-management-containers) |
| [Nginx Proxy Manager](#nginx-proxy-manager) | Network Management | Easy-to-use reverse proxy with SSL management | [Network Management](#network-management-containers) |
| [Portainer](#portainer) | Network Management | Docker container management web interface | [Network Management](#network-management-containers) |
| [Dockge](#dockge) | Network Management | Docker Compose stack management interface | [Network Management](#network-management-containers) |
| [Grafana](#grafana) | Monitoring & Analytics | Data visualization and monitoring dashboards | [Monitoring and Analytics](#monitoring-and-analytics-containers) |
| [Prometheus](#prometheus) | Monitoring & Analytics | Time-series database and monitoring system | [Monitoring and Analytics](#monitoring-and-analytics-containers) |
| [InfluxDB](#influxdb) | Monitoring & Analytics | Time-series database for metrics and events | [Monitoring and Analytics](#monitoring-and-analytics-containers) |
| [Telegraf](#telegraf) | Monitoring & Analytics | Data collection agent for metrics gathering | [Monitoring and Analytics](#monitoring-and-analytics-containers) |
| [Netdata](#netdata) | Monitoring & Analytics | Real-time system performance monitoring | [Monitoring and Analytics](#monitoring-and-analytics-containers) |
| [Beszel](#beszel) | Monitoring & Analytics | Lightweight server monitoring dashboard | [Monitoring and Analytics](#monitoring-and-analytics-containers) |
| [Bitwarden](#bitwarden) | Security & Privacy | Open-source password management solution | [Security and Privacy](#security-and-privacy-containers) |
| [OpenVPN](#openvpn) | Security & Privacy | Secure VPN server for remote access | [Security and Privacy](#security-and-privacy-containers) |
| [WireGuard](#wireguard) | Security & Privacy | Modern, fast, and secure VPN protocol | [Security and Privacy](#security-and-privacy-containers) |
| [Fail2Ban](#fail2ban) | Security & Privacy | Intrusion prevention system | [Security and Privacy](#security-and-privacy-containers) |
| [SearXNG](#searxng) | Security & Privacy | Privacy-focused metasearch engine | [Security and Privacy](#security-and-privacy-containers) |
| [Bookstack](#bookstack) | Productivity | Self-hosted wiki and documentation platform | [Productivity](#productivity-containers) |
| [Joplin](#joplin) | Productivity | Open-source note-taking and to-do application | [Productivity](#productivity-containers) |
| [Kanboard](#kanboard) | Productivity | Kanban project management software | [Productivity](#productivity-containers) |
| [Wekan](#wekan) | Productivity | Open-source collaborative kanban board | [Productivity](#productivity-containers) |
| [Docmost](#docmost) | Productivity | Self-hosted knowledge base and documentation | [Productivity](#productivity-containers) |
| [Stirling PDF](#stirling-pdf) | Productivity | Local PDF manipulation and processing tool | [Productivity](#productivity-containers) |
| [GitLab](#gitlab) | Development | Complete DevOps platform with Git repository | [Development](#development-containers) |
| [Jenkins](#jenkins) | Development | Automation server for CI/CD pipelines | [Development](#development-containers) |
| [Gitea](#gitea) | Development | Lightweight Git service with web interface | [Development](#development-containers) |
| [Drone CI](#drone-ci) | Development | Container-native continuous integration | [Development](#development-containers) |
| [MariaDB](#mariadb) | Database | Open-source relational database | [Database](#database-containers) |
| [PostgreSQL](#postgresql) | Database | Advanced open-source relational database | [Database](#database-containers) |
| [MongoDB](#mongodb) | Database | Document-oriented NoSQL database | [Database](#database-containers) |
| [Redis](#redis) | Database | In-memory data structure store and cache | [Database](#database-containers) |
| [Duplicati](#duplicati) | Backup & Recovery | Free backup client with encryption | [Backup and Recovery](#backup-and-recovery-containers) |
| [Restic](#restic) | Backup & Recovery | Fast and secure backup program | [Backup and Recovery](#backup-and-recovery-containers) |
| [Borgmatic](#borgmatic) | Backup & Recovery | Simple configuration wrapper for Borg backup | [Backup and Recovery](#backup-and-recovery-containers) |
| [Veeam](#veeam) | Backup & Recovery | Enterprise backup and recovery solution | [Backup and Recovery](#backup-and-recovery-containers) |
| [Firefly III](#firefly-iii) | Personal Finance | Personal finance manager and budgeting tool | [Personal Finance](#personal-finance-containers) |
| [GnuCash](#gnucash) | Personal Finance | Free accounting software | [Personal Finance](#personal-finance-containers) |
| [HomeBank](#homebank) | Personal Finance | Personal accounting and money management | [Personal Finance](#personal-finance-containers) |
| [PhotoPrism](#photoprism) | Photography & Images | AI-powered photo management and sharing | [Photography and Image Management](#photography-and-image-management-containers) |
| [Lychee](#lychee) | Photography & Images | Self-hosted photo management system | [Photography and Image Management](#photography-and-image-management-containers) |
| [Piwigo](#piwigo) | Photography & Images | Open-source photo gallery software | [Photography and Image Management](#photography-and-image-management-containers) |
| [Immich](#immich) | Photography & Images | High-performance photo and video backup solution | [Photography and Image Management](#photography-and-image-management-containers) |
| [Calibre-web](#calibre-web) | E-book Management | Web-based e-book library management | [E-book Management](#e-book-management-containers) |
| [COPS](#cops-calibre-opds-php-server) | E-book Management | Calibre OPDS and HTML server | [E-book Management](#e-book-management-containers) |
| [Ubooquity](#ubooquity) | E-book Management | Home server for comics and e-books | [E-book Management](#e-book-management-containers) |
| [Baserow](#baserow) | Database Solutions | No-code database and Airtable alternative | [Self-Hosted Database Solutions](#self-hosted-database-solutions-airtable-alternatives) |
| [NocoDB](#nocodb) | Database Solutions | Open-source Airtable alternative | [Self-Hosted Database Solutions](#self-hosted-database-solutions-airtable-alternatives) |
| [Teable](#teable) | Database Solutions | Real-time collaborative database | [Self-Hosted Database Solutions](#self-hosted-database-solutions-airtable-alternatives) |
| [Minecraft Server](#minecraft-server) | Game Servers | Dedicated Minecraft game server | [Game Server](#game-server-containers) |
| [Terraria Server](#terraria-server) | Game Servers | Dedicated Terraria game server | [Game Server](#game-server-containers) |
| [Factorio Server](#factorio-server) | Game Servers | Dedicated Factorio game server | [Game Server](#game-server-containers) |
| [Valheim Server](#valheim-server) | Game Servers | Dedicated Valheim game server | [Game Server](#game-server-containers) |
| [Mattermost](#mattermost) | Communication | Open-source team collaboration platform | [Communication](#communication-containers) |
| [Rocket.Chat](#rocketchat) | Communication | Open-source team communication platform | [Communication](#communication-containers) |
| [Jitsi Meet](#jitsi-meet) | Communication | Open-source video conferencing | [Communication](#communication-containers) |
| [Matrix Synapse](#matrix-synapse) | Communication | Decentralized communication server | [Communication](#communication-containers) |
| [Paperless-ng](#paperless-ng) | Document Management | Document management system with OCR | [Document Management](#document-management-containers) |
| [Mayan EDMS](#mayan-edms) | Document Management | Electronic document management system | [Document Management](#document-management-containers) |
| [OpenKM](#openkm) | Document Management | Document and knowledge management | [Document Management](#document-management-containers) |
| [WordPress](#wordpress) | Web Hosting | Popular content management system | [Web Hosting](#web-hosting-containers) |
| [Ghost](#ghost) | Web Hosting | Modern publishing platform | [Web Hosting](#web-hosting-containers) |
| [Drupal](#drupal) | Web Hosting | Flexible content management framework | [Web Hosting](#web-hosting-containers) |
| [Joomla](#joomla) | Web Hosting | Content management system | [Web Hosting](#web-hosting-containers) |
| [Heimdall](#heimdall) | Personal Dashboard | Application dashboard and launcher | [Personal Dashboard](#personal-dashboard-containers) |
| [Organizr](#organizr) | Personal Dashboard | Unified front-end for all your services | [Personal Dashboard](#personal-dashboard-containers) |
| [Homer](#homer) | Personal Dashboard | Static service dashboard | [Personal Dashboard](#personal-dashboard-containers) |
| [FreshRSS](#freshrss) | RSS Feeds | Self-hosted RSS feed aggregator | [RSS Feed](#rss-feed-containers) |
| [Tiny Tiny RSS](#tiny-tiny-rss) | RSS Feeds | Web-based RSS feed reader | [RSS Feed](#rss-feed-containers) |
| [Miniflux](#miniflux) | RSS Feeds | Minimalist RSS reader | [RSS Feed](#rss-feed-containers) |
| [Weewx](#weewx) | Weather Monitoring | Weather station software | [Weather Monitoring](#weather-monitoring-containers) |
| [Meteobridge](#meteobridge) | Weather Monitoring | Weather station data logger | [Weather Monitoring](#weather-monitoring-containers) |
| [Kimai](#kimai) | Time Tracking | Web-based time tracking application | [Time Tracking](#time-tracking-containers) |
| [TimeTagger](#timetagger) | Time Tracking | Open-source time tracking tool | [Time Tracking](#time-tracking-containers) |
| [Passbolt](#passbolt) | Password Management | Collaborative password manager | [Password Management](#password-management-containers) |
| [Vaultwarden](#vaultwarden-bitwarden-rs) | Password Management | Lightweight Bitwarden server | [Password Management](#password-management-containers) |
| [Asterisk](#asterisk) | VoIP | Open-source PBX and telephony platform | [VoIP](#voip-containers) |
| [FreePBX](#freepbx) | VoIP | Web-based PBX administration interface | [VoIP](#voip-containers) |

This table provides a quick reference to find the specific container you're looking for, along with its category and a brief description of its functionality.
