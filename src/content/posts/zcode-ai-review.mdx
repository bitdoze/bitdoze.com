...
description: "Hands-on Zcode review: free desktop AI coding agent with Goal Mode for long tasks, multi-model support, and Bot Channel for phone control. How it stacks up vs Cursor."
