...
meta_title: "Self-Host Convex in 2026: Docker Compose & Dokploy Setup"
description: "Deploy Convex backend on your VPS with Docker Compose or Dokploy. Covers SQLite, PostgreSQL, MySQL, reverse proxy, S3 storage, and Prometheus metrics."
image: "../../assets/images/25/11/convex-self-host.webp"
