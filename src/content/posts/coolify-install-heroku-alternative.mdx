...
> **Update (May 2026):** Coolify v4.0.0 has reached stable and v5 with multi-server scalability is coming. For a full review of the latest features, see our [Coolify v5 review](/coolify-v5-self-hosted-paas-review/). This guide covers the original v3/v4 install process.
