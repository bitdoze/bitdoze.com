...
meta_title: "VibeProxy: Use Your Claude, Codex & Gemini Subscriptions"
description: "Learn how to use VibeProxy to leverage your existing Claude Code, OpenAI Codex, Gemini, and Antigravity subscriptions with Factory AI Droids, Amp Code, Zed…"
image: "../../assets/images/25/12/vibeproxy-guide.webp"
categories: ["ai"]
authors: ["Dragos"]
