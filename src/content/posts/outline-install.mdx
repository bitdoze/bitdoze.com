...
<Picture formats={["webp"]} fallbackFormat="webp" src={img1} alt="Slack OAuth app configuration page showing redirect URL setup for Outline Wiki authentication" />
