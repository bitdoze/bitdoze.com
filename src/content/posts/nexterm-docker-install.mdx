...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="Nexterm web interface dashboard showing server connections" />
<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="Nexterm adding a new SSH server connection" />
