...
To have everything installed we need a VPS server, I have one from [Hetzner](https://go.bitdoze.com/hetzner), [Hostinger](https://go.bitdoze.com/hostinger-vps) created and added to a firewall that only allow connections to 443 and 22 port.
