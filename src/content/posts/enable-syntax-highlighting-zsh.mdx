...
If you'd rather have syntax highlighting without installing plugins, [Fish Shell](/install-fish-shell-ubuntu/) includes it by default. Check [Fish Shell vs Zsh](/fish-shell-vs-zsh/) for a side-by-side comparison.
