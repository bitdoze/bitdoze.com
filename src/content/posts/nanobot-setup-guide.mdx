...
meta_title: "NanoBot Setup Guide: MiniMax M2.5, GLM-5, and Brave Search"
description: "Step-by-step guide to installing nanobot on a Linux VPS with MiniMax M2.5, GLM-5 (Zhipu), Discord integration, and Brave Search."
...
Este artículo también está disponible en español: [Guía de Configuración de NanoBot](/es/guia-configuracion-nanobot/).
