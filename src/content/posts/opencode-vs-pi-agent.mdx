...
Both also support [OpenCode Go](https://go.bitdoze.com/opencode-go) as a built-in provider. At $10/month, it bundles 12 models including MiniMax M2.7, Qwen 3.6 Plus, GLM 5.1, DeepSeek V4 Pro, and Kimi K2.6. For a breakdown of these models and their benchmarks, see the [best cheap models guide](/best-cheap-models-hermes-agent/). For a detailed look at OpenCode Go with limits and real-world usage, see the [OpenCode Go guide](/opencode-go-plan/).
