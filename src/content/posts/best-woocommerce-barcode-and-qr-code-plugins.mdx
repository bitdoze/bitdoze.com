...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgYith} alt="YITH WooCommerce Barcodes and QR Codes plugin" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgOrderBarcodes} alt="WooCommerce Order Barcodes details page" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgUpi} alt="UPI QR Code Payment Gateway plugin" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgKaya} alt="Kaya QR Code Generator plugin" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgPaymentQr} alt="Payment QR WooCommerce plugin checkout" />
