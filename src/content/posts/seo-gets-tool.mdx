...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="SEO Gets dashboard showing multi-site overview with clicks and impressions data" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="SEO Gets website-level dashboard with keyword tracking, content groups, and traffic decay analysis" />
