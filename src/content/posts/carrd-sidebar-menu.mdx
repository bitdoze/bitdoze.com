...
<style>
  ...
  * {
  ...
  /* Position the menu button based on sidebar position */
  .sidebar-menu-toggle[data-position="left"] {
    left: var(--menu-button-position-side);
  }

  .sidebar-menu-toggle[data-position="right"] {
...
- **Floating Mode** (`--menu-button-floating: true`): The menu button will float on the screen at the specified position (top or bottom)
