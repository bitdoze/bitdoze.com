...
meta_title: "Hermes Agent Setup Guide (2026): Self-Improving AI"
description: "Install Hermes Agent v0.18 on Linux with free models from OpenRouter. Covers Docker Compose, Telegram, Discord, Slack, WhatsApp, and the built-in web dashboard."
...
Community-contributed skills live at [agentskills.io](https://agentskills.io). You can browse and install them, or publish your own. For a curated example of what a well-built skill looks like in practice, see my comparison of the [best AI skills for web design](/best-ai-skills-for-web-design/).
