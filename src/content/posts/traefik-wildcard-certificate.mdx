...
<Picture formats={["webp"]} fallbackFormat="webp" src={img2} alt="Cloudflare API token creation with Zone:DNS:Edit permissions for Traefik DNS challenge" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img1} alt="Traefik reverse proxy architecture diagram showing wildcard SSL certificate flow" />
