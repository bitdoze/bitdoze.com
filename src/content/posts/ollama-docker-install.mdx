...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="openwebui pull model" />

### 6. Using Open-WebUI

After you can go ahead and start using the Open-WebUI, you choose the model and start communicating.

<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="openwebui start" />
