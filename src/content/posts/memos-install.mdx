...
- VPS where you can host Memos, you can use one from [Hetzner](https://go.bitdoze.com/hetzner), [Hostinger](https://go.bitdoze.com/hostinger-vps) You can use a VPS to have Memos installed but performances will not be that good. In our test we are using a 8 CPUs 16 GB RAM and is bearly moving or use a [Mini PC as Home Server](https://www.bitdoze.com/best-mini-pc-home-server/)
