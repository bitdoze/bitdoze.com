...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="Memos self-hosted note-taking app dashboard" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="Memos Docker Compose settings page" />
