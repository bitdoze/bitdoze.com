...
meta_title: "How to Send Emails in WordPress Using Zoho SMTP"
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgFluentSmtp} alt="FluentSMTP settings configured with Zoho SMTP" />
