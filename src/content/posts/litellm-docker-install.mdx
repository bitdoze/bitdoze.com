...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="LiteLLM Diagram" />
...
LiteLLM sits next to OmniRoute, Langfuse, and the rest of the agent stack in [top AI GitHub repos](/top-ai-github-repos/).
