...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgHetznerYabs} alt="Hetzner CPX11 yabs.sh benchmark results" />

### DigitalOcean AMD

<Picture formats={["webp"]} fallbackFormat="webp" src={imgDoAmdYabs} alt="DigitalOcean Premium AMD yabs.sh benchmark results" />

### DigitalOcean Intel

<Picture formats={["webp"]} fallbackFormat="webp" src={imgDoIntelYabs} alt="DigitalOcean Premium Intel yabs.sh benchmark results" />

### Vultr Intel High Frequency (best overall)

<Picture formats={["webp"]} fallbackFormat="webp" src={imgVultrHfYabs} alt="Vultr Intel HF yabs.sh benchmark results" />

## WordPress benchmark

### Hetzner

<Picture formats={["webp"]} fallbackFormat="webp" src={imgHetznerWp} alt="Hetzner WordPress benchmark score" />

### DigitalOcean AMD

<Picture formats={["webp"]} fallbackFormat="webp" src={imgDoAmdWp} alt="DigitalOcean AMD WordPress benchmark score" />

### Vultr Intel HF

<Picture formats={["webp"]} fallbackFormat="webp" src={imgVultrHfWp} alt="Vultr Intel HF WordPress benchmark score" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgHetzner4Yabs} alt="Hetzner 4 CPU yabs.sh benchmark" />
<Picture formats={["webp"]} fallbackFormat="webp" src={imgHetzner4Wp} alt="Hetzner 4 CPU WordPress benchmark score" />
