...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="CloudPanel Create a Reverse Proxy" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag2} alt="CloudPanel Create a Reverse Proxy" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag3} alt="CloudPanel Port Open" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag4} alt="Dockge Add Compose" />
