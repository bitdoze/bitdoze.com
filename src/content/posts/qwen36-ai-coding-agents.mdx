...
**Do not want to choose:** [OpenCode Go](https://go.bitdoze.com/opencode-go) includes both Qwen 3.6 Plus and Qwen 3.5 Plus at $10/month. See the [OpenCode Go review](/opencode-go-review/) for limits and benchmarks. Switch between them and 12 other models based on the task.
