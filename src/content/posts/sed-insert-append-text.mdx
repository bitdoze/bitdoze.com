...
- GNU sed: `sed -i '...' file`
- BSD sed (macOS): `sed -i '' '...' file` (mandatory empty backup extension)
If you want a portable “safe edit” approach, write to a temp file and move it into place (examples included below).
</Notice>
