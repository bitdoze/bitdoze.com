...
description: "Use Astro DB for local-first development and host the production database on Bunny.net's managed libSQL instead of Turso."
image: "../../assets/images/26/06/astro-db-bunny-database.webp"
