...
As a start to get you going with node.js and GitHub you can check: [Install Node.js using NVM](https://www.bitdoze.com/install-nodejs-using-nvm-macos-ubuntu/) and [Link GitHub with A SSH Key](https://www.bitdoze.com/link-github-with-ssh-maco-linux/). If you are coming from WordPress, you might also want to read [how I migrated my WordPress site to Astro and MDX](https://www.bitdoze.com/wordpress-to-astro-migration/).
