...
- A VPS where you can host Slash. You can use [Hetzner](https://go.bitdoze.com/hetzner), [Hostinger](https://go.bitdoze.com/hostinger-vps), or use a [GMKtec M5 Ultra mini PC](/go/gmktec-m5-ultra/) as a [home server](https://www.bitdoze.com/best-mini-pc-home-server/)
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag3} alt="Dockge interface showing Slash Docker Compose stack deployment" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag4} alt="Cloudflare Zero Trust Tunnel configuration, adding a public hostname for Slash" />
