...
<Notice type="success" title="Get Started with Hetzner">
    New to Hetzner Cloud? [Get €20 credit](https://hetzner.cloud/?ref=bitdoze) when you sign up and test these new cost-optimized plans risk-free.
</Notice>
...
Run on the most recent AMD hardware generations available in a location.
...
<Notice type="success" title="€20 Free Credit">
    [Sign up for Hetzner Cloud](https://hetzner.cloud/?ref=bitdoze) and receive €20 credit to test these new Cost-Optimized plans. That's enough to run a CX33 server (4 vCPU, 8GB RAM) for almost 4 months free!
