...
<Picture formats={["webp"]} fallbackFormat="webp" src={img1} alt="DNS A Record" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img2} alt="Dokploy Compose" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img4} alt="Dokploy Domain add" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img3} alt="Dokploy env" />
