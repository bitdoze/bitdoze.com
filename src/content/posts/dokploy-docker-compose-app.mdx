...
For updating your deployed Docker Compose apps, see our guide on [How to Update Docker Compose Stacks in Dokploy](https://www.bitdoze.com/dokploy-update-docker-compose/).
