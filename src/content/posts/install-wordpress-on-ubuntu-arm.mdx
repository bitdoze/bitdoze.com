...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgDns} alt="Cloudflare DNS setup for CloudPanel" />

In CloudPanel → Settings, set the admin URL to your admin subdomain:

<Picture formats={["webp"]} fallbackFormat="webp" src={imgSettings} alt="CloudPanel admin URL settings" />

## Step 3: Create a WordPress site

Go to **Sites → Add Site → Create WordPress Website**:

<Picture formats={["webp"]} fallbackFormat="webp" src={imgCreate} alt="CloudPanel create website button" />

Enter your domain, username, password, and email:

<Picture formats={["webp"]} fallbackFormat="webp" src={imgDetails} alt="CloudPanel WordPress site details form" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgPhp} alt="CloudPanel PHP version configuration" />
