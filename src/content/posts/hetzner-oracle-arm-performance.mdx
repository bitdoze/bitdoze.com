...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgPricing} alt="Hetzner ARM server pricing" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgOracle} alt="Oracle ARM VPS benchmark results" />

### Hetzner CAX31 (4 vCPU, 8 GB RAM -- €11.99/month)

<Picture formats={["webp"]} fallbackFormat="webp" src={imgHetzner} alt="Hetzner ARM VPS benchmark results" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgWordpress} alt="WordPress benchmark on Hetzner ARM server" />

<Picture formats={["webp"]} fallbackFormat="webp" src={imgGtmatrix} alt="GTMatrix speed test on Hetzner ARM WordPress" />
