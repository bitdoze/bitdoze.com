...
If your needs grow beyond a single server, take a look at [Pluton](https://www.bitdoze.com/pluton-self-hosted-backup/). It wraps the same Restic engine but adds built-in replication for 3-2-1 setups, remote machine agents, and 80+ cloud destinations through Rclone. I compared both tools side by side in that walkthrough.
