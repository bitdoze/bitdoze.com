...
<Picture formats={["webp"]} fallbackFormat="webp" src={img1} alt="Breakdance Builder interface" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img2} alt="Breakdance design library" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img3} alt="Breakdance pricing plans" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img4} alt="Breakdance theme selection on setup" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img5} alt="Breakdance global settings panel" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={img6} alt="Breakdance header builder" />
