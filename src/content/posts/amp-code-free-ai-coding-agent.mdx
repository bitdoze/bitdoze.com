...
description: "Discover Amp Code, the AI coding agent from Sourcegraph. Learn about Amp Free with unlimited access, the CLI tool, IDE integration, and how it compares to paid alternatives."
...
Amp Code by Sourcegraph runs directly in your editor and terminal, giving you access to AI models. Amp Free mode offers unlimited access supported by ads, making AI coding assistance available to everyone.
...
Ready to try AI-powered coding? Install Amp today and start building with AI models!
