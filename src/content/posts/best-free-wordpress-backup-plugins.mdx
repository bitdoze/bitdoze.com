...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgWpvivid} alt="WPvivid Backup Plugin dashboard" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imgUpdraft} alt="UpdraftPlus Backup and Restoration plugin" />
