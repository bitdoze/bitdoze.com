...
CloudPanel has direct cloud integrations with [DigitalOcean](https://go.bitdoze.com/do), [Vultr](https://go.bitdoze.com/vultr), [Hetzner](https://go.bitdoze.com/hetzner), [Hostinger](https://go.bitdoze.com/hostinger-vps), AWS or Google Cloud. These integrations can help you create snapshots and enable automatic snapshot creations from CloudPanel UI.
