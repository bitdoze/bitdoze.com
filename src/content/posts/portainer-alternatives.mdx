...
Here is the honest annual comparison for 2026:
...
Decision-first. Here is the table, then the tree, then the reviews.
...
| Dockhand | 6,343 | BSL 1.1 | 2026-09-23 (v1.0.48) | Grype/Trivy safe-pull | MFA, LDAP | restic | Hawser | OpenAPI | Security-first management |
...
This is the record correction, itemized with release dates from the Arcane releases page (fetched 2026-09-23):
...
If you are building a 3-5 node homelab fleet for this kind of tooling, quiet nodes like [a compact mini PC such as the ASUS DC510](https://go.bitdoze.com/asus-dc510) beat a tower of old laptops on noise and power draw.
...
Arcane ships OIDC plus passkeys and MFA on the free tier. Sencho has OIDC with Google/GitHub/Okta presets, TOTP, and five-role RBAC free. Dockhand has MFA and LDAP in its free self-host tier. Portainer CE does not include OIDC/SSO at all; that is Business Edition.
</Accordion>
