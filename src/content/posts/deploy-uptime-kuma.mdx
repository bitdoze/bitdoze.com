...
description: "Learn how to deploy Uptime Kuma with 1 click in Docker via Coolify. Covers v2.x features including new notification providers, Globalping DNS, OracleDB…"
