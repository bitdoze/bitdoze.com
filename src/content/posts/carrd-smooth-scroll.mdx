...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="Carrd embed element set to Code type and Hidden style; use Head for style-only snippets and Body End for markup and scripts" />
...
<Picture formats={["webp"]} fallbackFormat="webp" src={imag1} alt="Carrd embed element set to Code, Hidden style, Body End placement for the back-to-top button markup and script" />
