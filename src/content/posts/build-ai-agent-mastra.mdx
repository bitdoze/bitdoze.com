...
description: "A step-by-step guide to building a lean AI assistant with the Mastra framework: file tools, shell, live web search, browser automation, and persistent memory."
