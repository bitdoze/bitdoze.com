...
- [x] **3.5 Best UPS for home server** — SERP verified genuinely open. Picks: **CyberPower CP1500PFCLCD** ($239.95, 1500VA/1000W pure sine, NUT-compatible — consensus homelab pick), **APC BR1500MS2** ($299.99, apcupsd story), **CP850PFCLCD** ($169.95) budget, **APC SMC1500-2UC** ($820.45) rackmount, **EcoFlow DELTA 3** (LiFePO4 long-runtime angle). Must-cover: pure sine wave required for active-PFC PSUs, USB/NUT graceful shutdown, runtime-at-real-load table. (done 2026-09-21: `best-ups-for-home-server.mdx` published, prices verified Sep 21 via Amazon/tinyfish — Bright Data MCP was 407-down all day. Pivots: **EcoFlow DELTA 2 discontinued/out of stock → pick is DELTA 3** ($599, B0DCBYMC9D, new slug `/go/ecoflow-delta-3/`); **PR1500LCDRTXL2U unavailable on Amazon at check** → SMC1500-2UC leads rackmount, PR1500 as stock-watch alternative).
