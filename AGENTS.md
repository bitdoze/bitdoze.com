...
Before any UI/design work, read **PRODUCT.md** (strategy: brand register, web platform, audience, positioning, principles) and **DESIGN.md** (visual system: Terminal Blue palette, Chivo headings + Aleo article body + Source Sans 3 UI chrome + JetBrains Mono code, lift-on-intent elevation, component specs). Quick summary:
